...
def transcribe_all(chunks: list, language: str = "english", output_dir: str | None = None) -> str:
    full_transcript = ""

    engine = "Sarvam AI" if language.lower() == "hinglish" else f"Groq {GROQ_TRANSCRIPTION_MODEL}"
